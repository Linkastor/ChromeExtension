var Oauth = {
	header: function(method, url, token){
	...
	request_token: function(callback) {
		...
		var authorization = Oauth.header(method, url, '');
	...
	access_token: function(authorization_result,callback) {
		var results_params = getUrlParams(authorization_result);
		
		method = 'POST';
		url = 'https://api.twitter.com/oauth/access_token';
		var authorization = Oauth.header(method, url, results_params['oauth_token']);
